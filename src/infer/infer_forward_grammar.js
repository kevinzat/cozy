...
var grammar = {
    Lexer: lexer2,
    ParserRules: [
    {"name": "Rule", "symbols": [(lexer2.has("given") ? {type: "given"} : given), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d]) => new ast.GivenAst(c)},
    ...
    {"name": "Rule", "symbols": [(lexer2.has("repeat") ? {type: "repeat"} : repeat), "LineRef"], "postprocess": ([a, b]) => new ast.RepeatAst(b)},
    {"name": "Rule", "symbols": [(lexer2.has("modus") ? {type: "modus"} : modus), (lexer2.has("ponens") ? {type: "ponens"} : ponens), "LineRef", "LineRef"], "postprocess": ([a, b, c, d]) => new ast.ModusPonensAst(c, d)},
    {"name": "Rule", "symbols": [(lexer2.has("direct") ? {type: "direct"} : direct), (lexer2.has("proof") ? {type: "proof"} : proof), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e]) => new ast.DirectProofAst(d)},
    {"name": "Rule", "symbols": [(lexer2.has("elim") ? {type: "elim"} : elim), (lexer2.has("and") ? {type: "and"} : and), "LineRef", (lexer2.has("left") ? {type: "left"} : left)], "postprocess": ([a, b, c, d]) => new ast.ElimAndAst(c, true)},
    {"name": "Rule", "symbols": [(lexer2.has("elim") ? {type: "elim"} : elim), (lexer2.has("and") ? {type: "and"} : and), "LineRef", (lexer2.has("right") ? {type: "right"} : right)], "postprocess": ([a, b, c, d]) => new ast.ElimAndAst(c, false)},
    {"name": "Rule", "symbols": [(lexer2.has("intro") ? {type: "intro"} : intro), (lexer2.has("and") ? {type: "and"} : and), "LineRef", "LineRef"], "postprocess": ([a, b, c, d]) => new ast.IntroAndAst(c, d)},
    {"name": "Rule", "symbols": [(lexer2.has("elim") ? {type: "elim"} : elim), (lexer2.has("or") ? {type: "or"} : or), "LineRef", "LineRef"], "postprocess": ([a, b, c, d]) => new ast.ElimOrAst(c, d)},
    {"name": "Rule", "symbols": [(lexer2.has("simple") ? {type: "simple"} : simple), (lexer2.has("cases") ? {type: "cases"} : cases), "LineRef", "LineRef"], "postprocess": ([a, b, c, d]) => new ast.SimpleCasesAst(c, d)},
    {"name": "Rule", "symbols": [(lexer2.has("cases") ? {type: "cases"} : cases), "LineRef", "LineRef", "LineRef"], "postprocess": ([a, b, c, d]) => new ast.CasesAst(b, c, d)},
    {"name": "Rule", "symbols": [(lexer2.has("intro") ? {type: "intro"} : intro), (lexer2.has("or") ? {type: "or"} : or), "LineRef", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen), (lexer2.has("right") ? {type: "right"} : right)], "postprocess": ([a, b, c, d, e, f]) => new ast.IntroOrAst(c, e, true)},
    {"name": "Rule", "symbols": [(lexer2.has("intro") ? {type: "intro"} : intro), (lexer2.has("or") ? {type: "or"} : or), "LineRef", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen), (lexer2.has("left") ? {type: "left"} : left)], "postprocess": ([a, b, c, d, e, f]) => new ast.IntroOrAst(c, e, false)},
    {"name": "Rule", "symbols": [(lexer2.has("contradiction") ? {type: "contradiction"} : contradiction), "LineRef", "LineRef"], "postprocess": ([a, b, c]) => new ast.PrincipiumContradictionisAst(b, c)},
    {"name": "Rule", "symbols": [(lexer2.has("absurdum") ? {type: "absurdum"} : absurdum), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d]) => new ast.ReductioAdAbsurdumAst(c)},
    {"name": "Rule", "symbols": [(lexer2.has("exfalso") ? {type: "exfalso"} : exfalso), "LineRef", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e]) => new ast.ExFalsoQuodlibetAst(b, d)},
    {"name": "Rule", "symbols": [(lexer2.has("verum") ? {type: "verum"} : verum)], "postprocess": ([a]) => new ast.AdLitteramVerumAst()},
    {"name": "Rule", "symbols": [(lexer2.has("tautology") ? {type: "tautology"} : tautology), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d]) => new ast.TautologyAst(c)},
    {"name": "Rule", "symbols": [(lexer2.has("equivalent") ? {type: "equivalent"} : equivalent), "LineRef", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e]) => new ast.EquivalentAst(b, d)},
    {"name": "Rule", "symbols": [(lexer2.has("elim") ? {type: "elim"} : elim), (lexer2.has("forall") ? {type: "forall"} : forall), "LineRef", (lexer2.has("lbrace") ? {type: "lbrace"} : lbrace), "Exprs", (lexer2.has("rbrace") ? {type: "rbrace"} : rbrace)], "postprocess": ([a, b, c, d, e, f]) => new ast.ElimForAllAst(c, list_to_array(e, true))},
    {"name": "Rule", "symbols": [(lexer2.has("intro") ? {type: "intro"} : intro), (lexer2.has("forall") ? {type: "forall"} : forall), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e]) => new ast.IntroForAllAst(d)},
    {"name": "Rule", "symbols": [(lexer2.has("intro") ? {type: "intro"} : intro), (lexer2.has("forall") ? {type: "forall"} : forall), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen), "Variables"], "postprocess": ([a, b, c, d, e, f]) => new ast.IntroForAllAst(d, list_to_array(f, true))},
    {"name": "Rule", "symbols": [(lexer2.has("elim") ? {type: "elim"} : elim), (lexer2.has("exists") ? {type: "exists"} : exists), "LineRef", (lexer2.has("variable") ? {type: "variable"} : variable)], "postprocess": ([a, b, c, d]) => new ast.ElimExistsAst(c, d.text)},
    {"name": "Rule", "symbols": [(lexer2.has("intro") ? {type: "intro"} : intro), (lexer2.has("exists") ? {type: "exists"} : exists), "LineRef", (lexer2.has("lbrace") ? {type: "lbrace"} : lbrace), "Expr", (lexer2.has("rbrace") ? {type: "rbrace"} : rbrace), (lexer2.has("variable") ? {type: "variable"} : variable)], "postprocess": ([a, b, c, d, e, f, g]) => new ast.IntroExistsAst(c, e, g.text)},
    {"name": "Rule", "symbols": [(lexer2.has("intro") ? {type: "intro"} : intro), (lexer2.has("exists") ? {type: "exists"} : exists), "LineRef", (lexer2.has("lbrace") ? {type: "lbrace"} : lbrace), "Expr", (lexer2.has("rbrace") ? {type: "rbrace"} : rbrace), (lexer2.has("variable") ? {type: "variable"} : variable), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e, f, g, h, i, j]) => new ast.IntroExistsAst(c, e, g.text, i)},
    {"name": "Rule", "symbols": [(lexer2.has("induction") ? {type: "induction"} : induction), "LineRef", "LineRef"], "postprocess": ([a, b, c]) => new ast.InductionAst(b, c)},
    {"name": "Rule", "symbols": [(lexer2.has("substitute") ? {type: "substitute"} : substitute), "LineRef", (lexer2.has("right") ? {type: "right"} : right), "LineRef"], "postprocess": ([a, b, c, d]) => new ast.SubstituteAst(b, true, d, undefined)},
    {"name": "Rule", "symbols": [(lexer2.has("substitute") ? {type: "substitute"} : substitute), "LineRef", (lexer2.has("left") ? {type: "left"} : left), "LineRef"], "postprocess": ([a, b, c, d]) => new ast.SubstituteAst(b, false, d, undefined)},
    {"name": "Rule", "symbols": [(lexer2.has("substitute") ? {type: "substitute"} : substitute), "LineRef", (lexer2.has("right") ? {type: "right"} : right), "LineRef", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e, f, g]) => new ast.SubstituteAst(b, true, d, f)},
    {"name": "Rule", "symbols": [(lexer2.has("substitute") ? {type: "substitute"} : substitute), "LineRef", (lexer2.has("left") ? {type: "left"} : left), "LineRef", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e, f, g]) => new ast.SubstituteAst(b, false, d, f)},
    {"name": "Rule", "symbols": [(lexer2.has("defof") ? {type: "defof"} : defof), (lexer2.has("predicate") ? {type: "predicate"} : predicate), "LineRef"], "postprocess": ([a, b, c]) => new ast.DefinitionAst(b.text, true, c, undefined)},
    {"name": "Rule", "symbols": [(lexer2.has("defof") ? {type: "defof"} : defof), (lexer2.has("predicate") ? {type: "predicate"} : predicate), "LineRef", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e, f]) => new ast.DefinitionAst(b.text, true, c, e)},
    {"name": "Rule", "symbols": [(lexer2.has("undef") ? {type: "undef"} : undef), (lexer2.has("predicate") ? {type: "predicate"} : predicate), "LineRef"], "postprocess": ([a, b, c]) => new ast.DefinitionAst(b.text, false, c, undefined)},
    {"name": "Rule", "symbols": [(lexer2.has("undef") ? {type: "undef"} : undef), (lexer2.has("predicate") ? {type: "predicate"} : predicate), "LineRef", (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d, e, f]) => new ast.DefinitionAst(b.text, false, c, e)},
    {"name": "Rule", "symbols": [(lexer2.has("apply") ? {type: "apply"} : apply), (lexer2.has("predicate") ? {type: "predicate"} : predicate), "LineRef"], "postprocess": ([a, b, c]) => new ast.ApplyAst(b.text, c, [])},
    {"name": "Rule", "symbols": [(lexer2.has("apply") ? {type: "apply"} : apply), (lexer2.has("predicate") ? {type: "predicate"} : predicate), "LineRef", (lexer2.has("lbrace") ? {type: "lbrace"} : lbrace), "Exprs", (lexer2.has("rbrace") ? {type: "rbrace"} : rbrace)], "postprocess": ([a, b, c, d, e, f]) => new ast.ApplyAst(b.text, c, list_to_array(e, true))},
    {"name": "Rule", "symbols": [(lexer2.has("algebra") ? {type: "algebra"} : algebra), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen)], "postprocess": ([a, b, c, d]) => new ast.AlgebraAst(c, [])},
    {"name": "Rule", "symbols": [(lexer2.has("algebra") ? {type: "algebra"} : algebra), (lexer2.has("lparen") ? {type: "lparen"} : lparen), "Prop", (lexer2.has("rparen") ? {type: "rparen"} : rparen), "LineRefs"], "postprocess": ([a, b, c, d, e]) => new ast.AlgebraAst(c, list_to_array(e, true).map(([t]) => t)) /* unwrap */},
    {"name": "LineRefs", "symbols": ["LineRef"], "postprocess": ([b]) => [b] /* wrap to avoid confusion with the list itself */},
    {"name": "LineRefs", "symbols": ["LineRefs", "LineRef"], "postprocess": ([a, b]) => [[b], a]},
    {"name": "LineRef", "symbols": ["AbsoluteLineRef"], "postprocess": ([a]) => list_to_array(a, true)},
    {"name": "LineRef", "symbols": ["Ups", (lexer2.has("constant") ? {type: "constant"} : constant)], "postprocess": ([a, b]) => ({up: a, lineNum: parseInt(b)})},
    {"name": "AbsoluteLineRef", "symbols": [(lexer2.has("constant") ? {type: "constant"} : constant)], "postprocess": ([a]) => parseInt(a)},
    {"name": "AbsoluteLineRef", "symbols": ["AbsoluteLineRef", (lexer2.has("dot") ? {type: "dot"} : dot), (lexer2.has("constant") ? {type: "constant"} : constant)], "postprocess": ([a, b, c]) => [parseInt(c), a]},
    {"name": "Ups", "symbols": [(lexer2.has("exp") ? {type: "exp"} : exp)], "postprocess": ([a]) => 1},
    {"name": "Ups", "symbols": ["Ups", (lexer2.has("exp") ? {type: "exp"} : exp)], "postprocess": ([a, b]) => a+1},
